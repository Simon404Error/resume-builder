...
一个纯前端、无需注册的在线简历编辑与美化工具。支持 **4 套精美模板**、**实时预览**、**模块自定义**和**一键导出 PDF**，所有数据保存在浏览器本地，无需担心隐私泄露。
...
所有填写的内容仅存储在浏览器本地，**不会上传到任何服务器**。导出 PDF 的过程完全在本地完成。
